...
diag = DiagTable()
diag.add_file('atmos_hourly', 3, 'hours', time_units='days')
...
diag.add_field('dynamics', 'height_half', time_avg=True, files=['atmos_hourly'])

diag.add_field('hs_forcing', 'teq', time_avg=True, files=['atmos_hourly'])
diag.add_field('hs_forcing', 'h_trop', time_avg=True, files=['atmos_hourly'])
...
namelist = Namelist({
    ...
    'hs_forcing_nml': {
        'equilibrium_t_option' : 'exoplanet',
        'ml_depth': 10.,
        'spinup_time': 86400.,
        'ka': -20.,
        'ks': -5.
    ...
    'constants_nml': {
        ...
        'omega': 7.2722052166430395E-005,
        'earthday_multiple': True
    },
